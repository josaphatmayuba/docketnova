  ...
  <div style={{ flex: 1, overflow: "auto", padding: "28px 36px 48px" }}>
    <div style={{ maxWidth: 980, margin: "0 auto" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 24, marginBottom: 28 }}>
        <div style={{
          width: 96, height: 96, borderRadius: 999, background: "#F5EFE2",
          display: "flex", alignItems: "center", justifyContent: "center",
          fontFamily: "var(--font-display)", fontWeight: 500, fontSize: 38, color: "#7A1F2B",
        ...
        <div style={{ flex: 1 }}>
          ...
          <h1 style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontWeight: 500,
                       fontSize: 44, color: "var(--ink-950)", letterSpacing: "-0.02em", margin: 0 }}>
            L'hon. Hélène Côté
          </h1>
          <div style={{ display: "flex", gap: 14, marginTop: 8, fontSize: 13, color: "var(--ink-600)" }}>
        ...
        <GhostButton icon="pin">{lang === "en" ? "Pin" : "Épingler"}</GhostButton>
      </div>
        ...
        <JCard title={lang === "en" ? "Recent rulings — labour" : "Arrêts récents — Travail"}>
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {[
              ...
              <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 12px", borderRadius: 8, border: "1px solid var(--border-1)" }}>
